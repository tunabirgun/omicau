...
FLOWCHART_STEPS = [
    ...
    ("Group-aware CV", "impute + scale + select fitted inside train folds only (leakage-safe)", COBALT),
...
def _model_card_md(audit: dict) -> str:
    ...
    lines = [
        ...
        "- Predicted probabilities may be miscalibrated (e.g. balanced class weights); recalibrate before use.",
        "- Research use only.",
        "",
